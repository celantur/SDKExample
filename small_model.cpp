...
const std::filesystem::path model_path = assets_path/"yolov8_all_640_small_static.onnx.enc"; 
const std::filesystem::path model_path_compiled = assets_path/"yolov8_all_640_small_static.openvino";
